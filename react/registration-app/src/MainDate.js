    ...
    <form onSubmit = {handleSubmit(onSubmit)}>
          ...
          <div className="name-enter">
           ...
           <h5 style={colorblack}>Общие данные:</h5>
            ...
            <input className="form-control form-control-sm"{...register('age', nameCheck.nameData.age)} />
            ...
            <input className="input-size"{...register('dateOfIssue', nameCheck.passportData.dataR)} />
             <br/> 
